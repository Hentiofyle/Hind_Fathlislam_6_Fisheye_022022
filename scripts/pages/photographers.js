...
// Ici je filtre les donnée selon l'id du photograph afin d'avoir les informations tel que coordonée, images etc..
...
async function photographerHeader (photographer) {
  ...
  photographerHeader__content.className = "photographer__header__content";
